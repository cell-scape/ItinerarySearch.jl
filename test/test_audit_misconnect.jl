# test/test_audit_misconnect.jl — Record types, AbstractStore contract,
# MCT bitmask decoding, MCT audit log writer, lookup_mct_traced,
# misconnect replayer + inspector + integration. Pulled out of
# runtests.jl so the parallel runner (one file per worker) still
# exercises these assertions.
