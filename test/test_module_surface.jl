# test/test_module_surface.jl — Top-level module sanity:
# Module loads, type-alias identities, and enum values. Pulled out of
# runtests.jl so the parallel runner (which runs one file per worker)
# exercises these same assertions.
